...
},{"./object":6,"./util":9,"vm":11}],2:[function(require,module,exports){
"use strict";
...
},{"./parsers":7}],3:[function(require,module,exports){
"use strict";
...
},{"./array":1,"./model":5,"./object":6,"./parsers":7,"./react_mixin":8,"./util":9,"pluralize":13}],5:[function(require,module,exports){
"use strict";
...
},{"./array":1,"./attrs":2,"./id_map":3,"./object":6,"./util":9,"./validations":10,"pluralize":13}],6:[function(require,module,exports){
"use strict";
...
var NUMBER_RE = /^[-]?([0-9]*[0-9][0-9]*(\.[0-9]+)?|[0]*\.[0-9]*[0-9][0-9]*)$/;function parseNumber(s) {
...
var ISO8601_DATE_RE = /^(\d\d\d\d)-(\d\d)-(\d\d)$/;function parsePercent(s) {
...
var NO_TZ_RE = /^\d\d\d\d-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.\d+)?$/;function parseDateTime(s) {
  var n;
  s = String(s);
  if (s.match(NO_TZ_RE)) {
    s += "Z";
...
var EMAIL_FORMAT = /^([^@\s]+)@([-a-z0-9]+\.+[a-z]{2,})$/i;function parseEmail(s) {
  s = String(s);
  return EMAIL_FORMAT.test(s) ? s : null;
}

var PHONE_FORMAT = /^\d{10}$/;
var PHONE_CHARS = /[\(\)\s-]/g;function parsePhone(s) {
  s = String(s);
  return PHONE_FORMAT.test(s.replace(PHONE_CHARS, "")) ? s : null;
}

var DURATION_RE = /^\s*(?:(?::?\d+)|(?::?\d+:\d+)|(?:\d+:\d+:\d+))\s*$/;function parseDuration(s) {
  s = String(s);
...
},{"./array":1,"./parsers":7,"./util":9}],11:[function(require,module,exports){
